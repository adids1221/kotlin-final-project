...
class MovieRemoteDataSource @Inject constructor(
    ...
    suspend fun getCasts(id: Int)=getResult { movieService.getCasts(id, "8e5ba8495daddc6d2438bfc535daa646") }


    suspend fun getActorDetails(id: Int) =
        getResult { movieService.getActorDetails(id, "8e5ba8495daddc6d2438bfc535daa646") }

   suspend fun getSimilarMovies(id: Int)=  getResult { movieService.getSimilarMovies(id, "8e5ba8495daddc6d2438bfc535daa646") }

    suspend fun getSimilarMovie(id: Int) =
        getResult { movieService.getSimilarMovie(id, "8e5ba8495daddc6d2438bfc535daa646") }

    suspend fun getRecommendations(id: Int)=getResult { movieService.getRecommendations(id, "8e5ba8495daddc6d2438bfc535daa646") }


    suspend fun getRecommended(id: Int) = getResult {movieService.getRecommended(id, "8e5ba8495daddc6d2438bfc535daa646")}


    suspend fun getReviews(id: Int) = getResult { movieService.getReviews(id, "8e5ba8495daddc6d2438bfc535daa646")}
